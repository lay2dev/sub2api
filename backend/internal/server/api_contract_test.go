...
func newContractDeps(t *testing.T) *contractDeps {
	...
	redeemService := service.NewRedeemService(redeemRepo, userRepo, subscriptionService, apiKeyService, cfg, nil, nil, nil, nil)
...
func (stubRedeemCodeRepo) ListUsagesByUser(ctx context.Context, userID int64, limit int) ([]service.RedeemCodeUsage, error) {
	return nil, nil
}
