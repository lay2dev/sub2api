...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	redeemService := service.NewRedeemService(redeemCodeRepository, userRepository, subscriptionService, apiKeyService, redeemCache, billingCacheService, client, apiKeyAuthCacheInvalidator)
